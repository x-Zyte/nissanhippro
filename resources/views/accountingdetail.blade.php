    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(grid_selector).jqGrid({
                ...
                datatype: "json",
                colNames: ['เลขที่ใบกำกับ', 'วันที่', 'ชื่อลูกค้า', 'รับเงินจากไฟแนนซ์สุทธิ', 'เงินขาด', 'เงินเกิน', 'ยอดรวมบัญชี 1', 'เงินขาด', 'เงินเกิน', 'ยอดรวมบัญชี 2', 'เงินขาด', 'เงินเกิน'],
                colModel: [
                    ...
                    {
                        name: 'totalaccount1', index: 'totalaccount1', width: 100, align: 'right', formatter: 'number'
                        , formatoptions: {decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2}
                    },
                    {
                        name: 'totalaccount1short',
                        index: 'totalaccount1short',
                        width: 100,
                        align: 'right',
                        formatter: 'number'
                        ,
                    ...
                    {
                        name: 'totalaccount1over',
                        index: 'totalaccount1over',
                        width: 100,
                        align: 'right',
                        formatter: 'number'
                        ,
                    ...
                    {
                        name: 'totalaccount2', index: 'totalaccount2', width: 100, align: 'right', formatter: 'number'
                        , formatoptions: {decimalSeparator: ".", thousandsSeparator: ",", decimalPlaces: 2}
                    },
                    {
                        name: 'totalaccount2short',
                        index: 'totalaccount2short',
                        width: 100,
                        align: 'right',
                        formatter: 'number'
                        ,
                    ...
                    {
                        name: 'totalaccount2over',
                        index: 'totalaccount2over',
                        width: 100,
                        align: 'right',
                        formatter: 'number'
                        ,
