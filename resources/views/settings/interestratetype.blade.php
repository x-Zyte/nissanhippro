@extends('app')
@section('title','ประเภทอัตราดอกเบี้ย')
...
@section('menu-settinginterestratetype-class','active')

@section('content')

    <h3 class="header smaller lighter blue"><i class="ace-icon fa fa-btc"></i> ประเภทอัตราดอกเบี้ย</h3>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(grid_selector).jqGrid({
                url:'{{ url('interestratetype/read') }}',
                datatype: "json",
                colNames:['ไฟแนนซ์', 'ชื่อประเภท', 'รายละเอียด'],
                colModel:[
                    {name:'finacecompanyid',index:'finacecompanyid', width:100, editable: true,edittype:"select",formatter:'select',editoptions:{value:"{{$finacecompanyselectlist}}"},editrules:{required:true},align:'left',
                ...
                editurl: "interestratetype/update",
                caption: "",
                height:'100%'
            });
