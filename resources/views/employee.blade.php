                    ...
                    jQuery("#"+subgrid_table_id).jqGrid({
                        ...
                        colModel:[
                            {name:'menu',index:'menu', width:150, editable: true,edittype:"select",formatter:'select',
                                editoptions:{value: "รับรถเข้าสต๊อก:รับรถเข้าสต๊อก;ลูกค้ามุ่งหวัง:ลูกค้ามุ่งหวัง;การขาย:การขาย;พนักงาน:พนักงาน;การตั้งค่าทั่วไป:การตั้งค่าทั่วไป;การตั้งค่ารถ:การตั้งค่ารถ;การตั้งค่าการขาย:การตั้งค่าการขาย"}
                                ,align:'left',stype:'select',searchrules:{required:true},searchoptions: { sopt: ["eq", "ne"]
                                , value: "รับรถเข้าสต๊อก:รับรถเข้าสต๊อก;ลูกค้ามุ่งหวัง:ลูกค้ามุ่งหวัง;การขาย:การขาย;พนักงาน:พนักงาน;การตั้งค่าทั่วไป:การตั้งค่าทั่วไป;การตั้งค่ารถ:การตั้งค่ารถ;การตั้งค่าการขาย:การตั้งค่าการขาย" }}
                        ],
                        viewrecords : true,
                        rowNum:10,
                        rowList:[10,20,30],
