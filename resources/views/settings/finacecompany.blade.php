...
@section('menu-settingfinacecompany-class','active')

@section('content')

    <h3 class="header smaller lighter blue"><i class="ace-icon fa fa-book"></i> บริษัทไฟแนนซ์</h3>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(grid_selector).jqGrid({
                url:'{{ url('finacecompany/read') }}',
                datatype: "json",
                colNames:['ชื่อบริษัทไฟแนนซ์', 'รายละเอียด'],
                colModel:[
