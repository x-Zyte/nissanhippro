        ...
        $(document).ready(function() {
            ...
            $(grid_selector).jqGrid({
                ...
                colModel:[
                    ...
                    {name:'registercost',index:'registercost', width:100,editable: true,editoptions:{},editrules:{required:true, number:true},align:'right',formatter:'number',formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 2, defaultValue: '0.00'}},
